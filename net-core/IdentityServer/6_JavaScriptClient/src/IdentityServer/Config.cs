...
namespace IdentityServer
{
    public static class Config
    {
        ...
        {
            var client1 = CreateJavaScriptClient("js", "JavaScript Client", "http://localhost:5003");
            var client2 = CreateJavaScriptClient("js2", "JavaScript Client 2", "http://localhost:5004");
